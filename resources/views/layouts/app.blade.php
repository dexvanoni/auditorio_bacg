...
<head>
  ...
  <title>{{ config('app.name', 'Agenda Auditório BACG') }}</title>
  ...
  <style>
    ...
    <!--INPUTS COM A CAIXA PERSONALIZADA-->
    .form-group {
      position: relative;
    ...
    .form-group input {
      border: none;
      border-bottom: 1px solid #ced4da; /* cor da linha inferior */
      border-radius: 0;
      box-shadow: none;
      outline: none;
      padding: 0.5rem 0;
      background-color: transparent; /* remover o fundo do input */
    }
    .form-group input:focus {
      border-color: #80bdff; /* cor da linha inferior quando o input está em foco */
    }
    .form-group label {
      position: absolute;
      top: 0;
      ...
      <div class="page-wrapper chiller-theme toggled">
        ...
        <nav id="sidebar" class="sidebar-wrapper">
          <div class="sidebar-content">
            <div class="sidebar-brand">
              <a href="{{ route('home') }}">Auditório - BACG</a>
        ...
        <!--<div class="user-pic">
          ...
          <div class="user-info">
            ...
            @else
                <a href="">Realize o login para administrar!</a>
            @endisset
          </span>
        </div>
      </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var mensagem = "ATENÇÃO!\n\nAgendamento do auditório da BACG:\n- Público mínimo: 150 participantes;\n- Agendamento com antecedência mínima de 2 dias úteis;\n\nPara agendamentos fora dos parâmetros exigidos, favor entrar em contato com a Secretaria do Comando durante o expediente administrativo da BACG para solicitação direta ao Comandante.";
